/*
 Exemplos - v0.0. - 27 / 08 / 2023
 Author: 817294_Felipe_Vilhena_Dias

 Para compilar em terminal (janela de comandos):
 Linux : gcc -o Exemplos Exemplos.c
 Windows: gcc -o Exemplos Exemplos.c
...
void method_04(void) {
  ...
  // identificar
  IO_id("Exemplos0204 - Programa - v0.0");
...
void method_07(void) {
  ...
  // testar valores
  if (!(('a' <= x && x <= 'z') ||
        ('A' <= x && x <= 'Z'))) // NÂO (minuscula OU maiuscula)
  {
    IO_printf("%s (%c)\n", "Valor diferente de letra", x);
  } else {
    IO_printf("%s (%c)\n", "Letra", x);
...
void method_10(void) {
  ...
  case 0:
    IO_println(
        IO_concat("Valor igual a zero (", IO_concat(IO_toString_d(x), ")\n")));
    break;
  case 1:
    IO_println(
        IO_concat("Valor igual a um (", IO_concat(IO_toString_d(x), ")\n")));
    break;
  case 2:
    IO_println(
        IO_concat("Valor igual a dois (", IO_concat(IO_toString_d(x), ")\n")));
    break;
  case 3:
    IO_println(
        IO_concat("Valor igual a três (", IO_concat(IO_toString_d(x), ")\n")));
    break;
  default: // se nao for alguma das opcoes anteriores
...
0.1                    00.                     (OK) condicional 0 ou diferente
de 0 0.2                    00.                     (OK) condicional 0 ou
diferente de 0 usando else 0.3                    00.                     (OK)
condicional  maior ,menor ou igual a 0 0.4                    00. (OK) intervalo
[1:10] 0.5                    00.                     (OK) Letras maiusculas,
minusculas e algorismos 0.6                    00.                     (OK)
Letras maiusculas e minusculas usando OR (||)  ] 0.7                    00. (OK)
NÂO(!) maiusculas e minusculas usando OR (||) 0.8                    00. (OK)
'0', 'a' ou 'A', usando switch case 0.9                    00. (OK) '0', '1','2'
ou '3', usando switch case 1.0                    00.                     (OK)
'0', '1','2' ou '3', usando switch case, e concat de string
*/
