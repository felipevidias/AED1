/*
 Exemplo0110 - v0.0. - 21 / 08 / 2023
 Author: 817294_Felipe_Vilhena_Dias

 Para compilar em terminal (janela de comandos):
 Linux : gcc -o exemplo0109 exemplo0110.c
 Windows: gcc -o exemplo0109 exemplo0110.c
...
void method_09(void) {
  ...
  char z = 'A';   // definir variavel com valor inicial para guardar caractere
                  // (simbolo)
  bool w = false; // definir variavel com valor inicial para guardar falso ou
                  // verdadeiro
  ...
  w = true;
  x = w; // codigo equivalente ao logico
  printf("09. %s%c -> %d\n", "z = ", z, x);

  x = (w ==
       false); // equivalente a comparacao de igualdade ( true igual a false )
  printf("10. %s%d -> %d\n", "x = ", x, w);

  x = !(w == false); // equivalente ao contrario da comparacao de valores (true
                     // igual a false)
  printf("11. %s%d -> %d\n", "x = ", x, w);

  x = (w != false); // equivalente 'a comparacao de diferenca (true diferente de
                    // false)
  printf("12. %s%d -> %d\n", "x = ", x, w);
  ...
  w = (x < y); // equivalente a comparacao de (x) e (y)
  printf("15. %s%d != %d = %d\n", "w = ", x, 0, w);
  ...
  x = 4;
  w = (x % 2 != 0); // equivalente a tester se é impar ou
                    // resto inteiro (%) da divisao por 2 diferente de zero
  printf("20. %s (%d%%2) ? %d\n", "e' impar ", x, w);

  z = '5';
  w = ('0' <= z &&
       z <= '9'); // equivalente a testar se é algoritmo/digito
                  // pertence a [‘0’:’9’] (é igual ou esta’ entre ‘0’ e ‘9’)
  printf("21. %s (%c) ? %d\n", "e' digito", z, w);

  z = 'x';
  w = ('a' <= 'z' &&
       z <= 'z'); // equivalente a testar se e' letra minuscula,
                  // pertence a [‘a’:’z’] (é igual ou esta’ entre ‘a’ e ‘z’)
  printf("22. %s (%c) ? %d\n", "e' minuscula ", z, w);

  z = 'X';
  w = (!('a' <= z &&
         z <= 'z')); // equivalente a testar se NAO (!) e' letra minuscula
  printf("23. %s (%c) ? %d\n", "nao e' minuscula ", z, w);
  ...
  z = 'X';
  w = ((z < 'A') || ('Z' < z)); // equivalente a testar se NAO e' letra
                                // maiuscula, esta’ fora do intervalo [’a’:’z’],
                                // ou e’ menor que ‘a’ ou e’ maior que ‘z’
  printf("25. %s (%c) ? %d\n", "nao e' maiuscula ", z, w);
  ...
  w = (strcmp("zero", s) !=
       0); // comparar se caracteres diferentes (NAO usar "==" com caracteres)
  ...
  strcpy(s, "um e dois"); // copiar para (s) <- "outras palavras" (NAO usar '='
                          // com caracteres);
...
void method_10(void) {
  // definir dados
  int x = 5;                        // definir dado com valor inicial
  double y = 3.5;                   // definir dado com valor inicial
  char z = 'A';                     // definir dado com valor inicial
  bool w = TRUE;                    // definir dado com valor inicial
  ...
  chars c = IO_new_chars(STR_SIZE); // definir variavel com tamanho
...
/*
   ...
   comentarios
    ...
    0.8                  08.              (OK) identificacao de programa
    0.9                  09.              (OK) identificacao de programa
    1.0                  10.              (OK) identificacao de programa
